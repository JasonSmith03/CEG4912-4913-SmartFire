...
import { View, StyleSheet, KeyboardAvoidingView, ScrollView, Keyboard, InteractionManager } from 'react-native';
...
import { showInfo, validatePhoneNumber, validateRequiredField } from '../utils';
            ...
            <ScrollView style={s.f1}>
              <KeyboardAvoidingView>
                <View style={s.wrapper}>
                  <Field component={InputField} label="Emergency Contact" name="deviceEmergencyContact" validate={validatePhoneNumber} />
                </View>
              </KeyboardAvoidingView>
            </ScrollView>
